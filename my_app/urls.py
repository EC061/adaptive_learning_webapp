...
urlpatterns = [
    ...
    path(
        "test-results/<int:topic_id>/<int:subtopic_id>/",
        test_results,
        name="test_results",
    ),
    path(
        "submit-test/<int:topic_id>/<int:subtopic_id>/", submit_test, name="submit_test"
    ),
    path(
        "learning-video/<int:topic_id>/<int:subtopic_id>/",
        learning_video,
        name="learning_video",
    ),
    ...
    path(
        "submit_experimental_test/",
        views.submit_experimental_test,
        name="submit_experimental_test",
    ),
    path(
        "experiment-results/",
        views.experiment_test_results,
        name="experiment_test_results",
    ),
    ...
    path("api/ai-chat-helper/", ai_chat_helper, name="ai_chat_helper"),
