...
questions_data = [
    ...
    },
    {
        ...
        "options": [
            (
                "Joy says: “Yes it does, but the boiling water is just not as hot as it is here.”",
                True,
            ),
            (
                "Tay says: “That’s not true. Water always boils at the same temperature.”",
                False,
            ),
            (
            ...
            (
                "Mai says: “I agree with Jim. The water never gets to its boiling point.”",
                False,
            ),
        ],
    },
    ...
    },
    {
        ...
        "options": [
            (
                "Jon says: “The cold has been transferred from the cola to the bench.”",
                False,
            ),
            (
                "Rob says: “There is no energy left in the bench beneath the can.”",
                False,
            ),
            (
                "Sue says: “Some heat has been transferred from the bench to the cola.”",
                True,
            ),
            (
                "Eli says: “The can causes heat beneath the can to move away through the bench-top.”",
                False,
            ),
        ],
    },
    {
        ...
        "options": [
            ...
            (
                "Nic says: “Neither because they both contain the same amount of heat.”",
                False,
            ),
            (
                "Mat says: “There’s no answer, because ice doesn’t contain any heat.”",
                False,
            ),
            (
                "Jed says: “There’s no answer, because you can’t get water at 0°C.”",
                False,
            ),
        ],
    },
    ...
    },
    {
        ...
        "options": [
            (
                "Jim agrees and says: “They are colder because metal is naturally colder than plastic.”",
                False,
            ),
            (
                "Kip says: “They are not colder, they are at the same temperature.”",
                True,
            ),
            (
                "Lou says: “They are not colder, the metal ones just feel colder because they are heavier.”",
                False,
            ),
            (
                "Mai says: “They are colder because metal has less heat to lose than plastic.”",
                False,
            ),
        ],
    },
    {
        ...
        "options": [
            (
                "Jen says: “That means it will be twice as cold tonight as it was last night.”",
                False,
            ),
            ("Ali says: “That’s not right. 5°C is not twice as cold as 10°C.”", True),
            (
                "Raj says: “It’s partly right, but she should have said that 10°C is twice as warm as 5°C.”",
                False,
            ),
            (
                "Guy says: “It’s partly right, but she should have said that 5°C is half as cold as 10°C.”",
                False,
            ),
        ],
    },
    ...
    },
    {
        ...
        "assigned_at": 0,
        "difficulty_level": "Intermediate",
        "options": [("26°C", True), ("21°C", False), ("20°C", False), ("18°C", False)],
    },
    {
    ...
    },
    {
        ...
        "options": [
            (
                "Emi says: “It’s because the pressure causes water to boil above 100°C.”",
                True,
            ),
            ("Col says: “It’s because the high pressure generates extra heat.”", False),
            (
                "Fay says: “It’s because the steam is at a higher temperature than the boiling soup.”",
                False,
            ),
            (
                "Tom says: “It’s because pressure cookers spread the heat more evenly through the food.”",
                False,
            ),
        ],
    },
    {
        ...
        "options": [
            ...
            (
                "Sam says that it is hotter because metal trays concentrate the heat.",
                False,
            ),
            (
                "Ray says it’s hotter at the top because the hotter the air the less dense it is.",
                True,
            ),
            (
                "Tim disagrees with them all and says that it’s not possible to be hotter at the top.",
                False,
            ),
        ],
    },
    {
        ...
        "options": [
            (
                "wets the surface, and wet surfaces draw more heat out than dry surfaces.",
                False,
            ),
            (
                "drains heat from the pores and spreads it out over the surface of the skin.",
                False,
            ),
            (
                "is the same temperature as your skin but is evaporating and so is carrying heat away.",
                False,
            ),
            (
    ...
    },
    {
        ...
        "options": [
            (
                "Deb says: “You’re right because the wooden sticks don’t get as cold as ice does.”",
                False,
            ),
            (
                "Ian says: “You're right because ice contains more cold than wood does.”",
                False,
            ),
            (
                "Ros says: “You’re wrong, they only feel different because the sticks contain more heat.”",
                False,
            ),
            (
                "Ann says: “I think they are at the same temperature because they are together.”",
                True,
            ),
        ],
    },
    {
        ...
        "options": [
            (
                "Joe doubts this: “You must have made a mistake. You can’t have a temperature as low as that.”",
                False,
            ),
            (
                "Kay disagrees: “Yes you can. There’s no limit on the lowest temperature.”",
                False,
            ),
            (
                "Leo believes he is right: “I think the magnet was near the lowest temperature possible.”",
                True,
            ),
            (
    ...
    },
    {
        ...
        "options": [
            (
                "Nic replied: “It’s because the blankets you used were probably poor insulators.”",
                False,
            ),
            (
                "Lyn replied: “It’s because the blankets you used were probably poor conductors.”",
                False,
            ),
            (
                "Jay replied: “It’s because the dolls were made of material which did not hold heat well.”",
                False,
            ),
            (
                "Kev replied: “It’s because the dolls were made of material which took a long time to warm up.”",
                False,
            ),
...
for question_data in questions_data:
    if "topic_order" in question_data:
        topic_obj, _ = Topic.objects.get_or_create(
            topic_order=question_data["topic_order"],
            defaults={"topic_name": question_data["topic"]},
        )
    else:
    ...
    if "subtopic_order_number" in question_data:
        subtopic_obj, _ = Subtopic.objects.get_or_create(
            subtopic_order_number=question_data["subtopic_order_number"],
            defaults={"subtopic_name": question_data["subtopic"], "topic": topic_obj},
        )
    else:
        subtopic_obj, _ = Subtopic.objects.get_or_create(
            subtopic_name=question_data["subtopic"], topic=topic_obj
        )
    ...
    print(
        f"Inserted Question ID: {question.question_id}, Text: {question.question_text}"
    )
